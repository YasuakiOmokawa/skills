...
以下の場合のみ `domain-driven-design.md` 本体を Read する:

- Entity / Value Object の具体実装例 (Ruby / TypeScript) が必要
- Aggregate の実装パターンを提示したい
- Rails ActiveRecord とのアプローチ 1 vs 2 の判断で迷う
- Domain Service / Domain Event の Ruby 実装例が必要
