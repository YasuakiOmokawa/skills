...
2. [critical] `Freee::Client` / `XPROJ-663` / `fy26q3_ledger_client` は維持し、番号・案ラベル (`K-2` / `AC-12` / `案 D`) は出現回数によらず実値へ言い換えている (in-line 定義ルートに載せていない)
